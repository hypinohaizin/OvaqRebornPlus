...
public class BlockLagModule extends ObsidianPlacerModule
{
    ...
    Config<Mode> modeConfig = (new EnumConfig<>("Mode", "The mode for block fill", Mode.BLOCK_LAG, Mode.values()));
    // Config<Boolean> strictConfig = (new BooleanConfig("Strict", "Allows you to fake lag on strict servers", false);
    Config<Boolean> attackConfig = (new BooleanConfig("Attack", "Attacks crystals in the way of block", true, () -> modeConfig.getValue() == Mode.BLOCK_LAG));
    ...
    {
        super("BlockLag", "Fills in the block your standing on", ModuleCategory.COMBAT);
    }
