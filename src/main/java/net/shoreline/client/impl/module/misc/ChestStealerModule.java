...
{
    Config<List<Item>> itemsConfig = (new ItemListConfig<>("Items", "Items to steal", Items.SHULKER_BOX));
    Config<Float> delayConfig = (new NumberConfig<>("Delay", "The item steal delay", 0.0f, 0.15f, 2.0f));
    private final Timer stealTimer = new CacheTimer();

    public ChestStealerModule()
    {
        super("ChestStealer", "Steals items from chests", ModuleCategory.MISC);
    }
