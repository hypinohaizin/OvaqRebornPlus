...
public class AutoLogModule extends ToggleModule
{
    ...
    Config<Boolean> invincibilityConfig = (new BooleanConfig("SpawnInvincibility", "Accounts for spawn invincibility for logout", false));
    Config<Float> invincibilityTimeConfig = (new NumberConfig<>("InvincibilityTime", "The spawn invincibility time ", 0.1f, 2.9f, 5.0f, () -> invincibilityConfig.getValue()));
    ...
    Config<Boolean> autoDisableConfig = (new BooleanConfig("AutoDisable", "Automatically disables", true));
