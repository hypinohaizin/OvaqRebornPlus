...
public final class AutoTrapModule extends ObsidianPlacerModule
{
    ...
    Config<Boolean> multitaskConfig = (new BooleanConfig("Multitask", "Allows placing while eating", true));
    ...
    Config<Boolean> headConfig = (new BooleanConfig("Head", "Place a block at targets head", true));
    Config<Boolean> antiStepConfig = (new BooleanConfig("PreventStep", "Prevents target from stepping out of the trap", false));
