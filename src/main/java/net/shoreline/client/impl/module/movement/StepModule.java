...
public class StepModule extends ToggleModule
{
    ...
    Config<Boolean> strictConfig = (new BooleanConfig("Strict", "Confirms the step height for NCP servers", false, () -> modeConfig.getValue() == StepMode.NORMAL && heightConfig.getValue() <= 2.5f));
