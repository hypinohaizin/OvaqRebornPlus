...
{
    Config<Integer> zoomConfig = (new NumberConfig<>("Zoom", "The zoom value", 10, 30, 50));
    Config<Boolean> smoothCameraConfig = (new BooleanConfig("SmoothCamera", "Adds motion reduction to the camera", true));
    Config<Macro> zoomKeyConfig = (new MacroConfig("ZoomKey", "The zoom key bind", new Macro(getId() + "-zoomkey", GLFW.GLFW_KEY_C, () -> {})));
