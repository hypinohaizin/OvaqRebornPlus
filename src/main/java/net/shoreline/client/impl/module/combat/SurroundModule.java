...
public class SurroundModule extends ObsidianPlacerModule
{
    ...
    Config<Boolean> prePlaceTickConfig = (new BooleanConfig("PrePlace-Tick", "Pre places before ticks", false, () -> timingConfig.getValue() == Timing.SEQUENTIAL));
    ...
    Config<Boolean> mineExtendConfig = (new BooleanConfig("MineExtend", "Extends surround if the block is being mined", false));
    ...
    public List<BlockPos> getSurround(PlayerEntity player) {
        ...
        if (Modules.AIR_INTERACT != null && Modules.AIR_INTERACT.isEnabled() && headConfig.getValue()) {
