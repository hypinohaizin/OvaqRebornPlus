...
{
    private static AirInteractModule INSTANCE;

    Config<Boolean> manualConfig = (new BooleanConfig("Click", "Allow manual air place", true));
    Config<Boolean> grimConfig = (new BooleanConfig("Grim", "Place on air on grim", false));
    Config<Float> rangeConfig = (new NumberConfig<>("Range", "The range to air place", 1.0f, 4.0f, 6.0f, NumberDisplay.DEFAULT));
    Config<Boolean> fluidsConfig = (new BooleanConfig("Fluids", "Place against fluids", false));
    ...
    public void onRenderWorld(final RenderWorldEvent event)
    {
        ...
        RenderManager.renderBoundingBox(event.getMatrices(), blockPos, 1.5f, Modules.COLORS.getRGB(145));
