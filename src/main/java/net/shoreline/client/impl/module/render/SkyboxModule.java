...
public class SkyboxModule extends ToggleModule
{
    ...
    Config<Float> fogStartConfig = (new NumberConfig<>("FogStart", "The fog start distance", 0.0f, 0.0f, 256.0f, () -> fogConfig.getValue()));
    Config<Float> fogEndConfig = (new NumberConfig<>("FogEnd", "The fog start distance", 10.0f, 64.0f, 256.0f, () -> fogConfig.getValue()));
