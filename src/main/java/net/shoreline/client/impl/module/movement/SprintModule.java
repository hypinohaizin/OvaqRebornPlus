...
public class SprintModule extends RotationModule
{
    ...
    Config<Boolean> jumpFixConfig = (new BooleanConfig("JumpFix", "Fixes jumping slowdown in Rage sprint", true, () -> modeConfig.getValue() == SprintMode.RAGE || modeConfig.getValue() == SprintMode.RAGE_STRICT));
