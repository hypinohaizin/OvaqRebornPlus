...
{
    Config<Float> rangeConfig = (new NumberConfig<>("Range", "Range to place beds", 1.0f, 4.5f, 6.0f));
    ...
    {
        super("BedAura", "Automatically places and explodes beds (designed for 1.13+)", ModuleCategory.DEV);
    }
