...
public class KillEffectsModule extends ToggleModule
{
    ...
    Config<KillEffect> killEffectConfig = (new EnumConfig<>("Effect", "The kill effect to apply", KillEffect.LIGHTNING, KillEffect.values()));
    Config<Integer> strikesConfig = (new NumberConfig<>("Strikes", "The number of lightning strikes", 1, 1, 5, () -> killEffectConfig.getValue() == KillEffect.LIGHTNING));
