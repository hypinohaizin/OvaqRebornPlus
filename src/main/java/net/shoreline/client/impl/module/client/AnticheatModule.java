...
public class AnticheatModule extends ConcurrentModule
{
    ...
    Config<Anticheats> modeConfig = (new EnumConfig<>("Mode", "Applies anticheat optimizations", Anticheats.VANILLA, Anticheats.values()));
    Config<Boolean> miningFixConfig = (new BooleanConfig("MiningFix", "Fixes vanilla mining on GrimV3", false, () -> modeConfig.getValue() == Anticheats.GRIM));
    Config<Boolean> webJumpFixConfig = (new BooleanConfig("WebJumpFix", "Fixes sprint jumping in webs on grim", false, () -> modeConfig.getValue() == Anticheats.GRIM));
    Config<Boolean> raytraceSpoofConfig = (new BooleanConfig("RaytraceFix", "Allows you to spoof your raytrace", false, () -> modeConfig.getValue() == Anticheats.N_C_P));
