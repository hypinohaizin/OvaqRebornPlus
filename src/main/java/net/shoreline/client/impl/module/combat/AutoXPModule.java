...
public class AutoXPModule extends RotationModule
{
    ...
    Config<Boolean> multiTaskConfig = (new BooleanConfig("MultiTask", "Allows you to throw xp while using items", false));
    Config<Float> delayConfig = (new NumberConfig<>("Delay", "Delay to throw xp in ticks", 1.0f, 1.0f, 10.0f, NumberDisplay.DEFAULT));
    Config<Integer> shiftTicksConfig = (new NumberConfig<>("ShiftTicks", "The number of xp bottles to throw in one tick", 1, 1, 64));
