...
{
    Config<Float> lengthConfig = (new NumberConfig<>("Length", "The crosshair length", 0.0f, 1.0f, 2.5f));
    Config<Float> thicknessConfig = (new NumberConfig<>("Thickness", "The crosshair thickness", 0.1f, 0.5f, 2.0f));
    Config<Integer> gapConfig = (new NumberConfig<>("Gap", "The gap between the lines", 1, 2, 5));
    Config<Boolean> dynamicConfig = (new BooleanConfig("Dynamic", "Indicates when the player is moving", false));
    Config<Boolean> outlineConfig = (new BooleanConfig("Outline", "Outlines the crosshair", true));
    Config<Float> outlineThicknessConfig = (new NumberConfig<>("OutlineThickness", "The width of the outline", 0.1f, 0.3f, 0.5f, () -> outlineConfig.getValue()));
    Config<Float> opacityConfig = (new NumberConfig<>("Opacity", "The crosshair opacity", 0.10f, 1.00f, 1.00f));
    Config<Color> colorConfig = (new ColorConfig("Color", "The crosshair color", Color.WHITE));
