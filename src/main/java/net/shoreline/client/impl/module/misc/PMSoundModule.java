...
public class PMSoundModule extends ToggleModule
{
    ...
    Config<PMSounds> soundsConfig = (new EnumConfig<>("Sounds", "The sound to play for PM", PMSounds.TWITTER, PMSounds.values()));

    public PMSoundModule()
    {
        super("PMSound", "Plays a sound for private messages", ModuleCategory.MISC);
        INSTANCE = this;
    }
