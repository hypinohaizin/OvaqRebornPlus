...
public class FlightModule extends ToggleModule
{
    ...
    Config<Float> vspeedConfig = (new NumberConfig<>("VerticalSpeed", "The vertical flight speed", 0.1f, 1.0f, 20.0f));
    Config<AntiKick> antiKickConfig = (new EnumConfig<>("AntiKick", "Prevents vanilla flight detection", AntiKick.NORMAL, AntiKick.values()));
